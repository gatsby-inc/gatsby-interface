...
declare module "gatsby-design-tokens" {
  ...
  export const zIndices: Record<'widget' | 'navigation' | 'banner' | 'modal' | 'sidebar' | 'floatingActionButton' | 'skipLink', number>
}
